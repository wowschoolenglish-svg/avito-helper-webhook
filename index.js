...
<head>
  ...
  <meta name="description" content="Официальная интеграция с Avito Messenger API: мгновенный первый ответ 24/7, шаблоны и аналитика." />
  ...
  <style>
    ...
    .hero{padding:72px 0}
    .btn{padding:12px 18px;border-radius:10px;border:1px solid #111;text-decoration:none}
    .grid{display:grid;gap:16px;grid-template-columns:repeat(auto-fit,minmax(240px,1fr))}
    footer{margin-top:48px;padding:24px 0;border-top:1px solid #eee;color:#666;font-size:14px}
    a{color:#111}
  </style>
</head>
<body>
<header class="container" style="display:flex;justify-content:space-between;align-items:center;padding:16px 0">
  <div style="font-weight:800;display:flex;align-items:center;gap:8px">
    <img src="/favicon.svg" alt="" width="20" height="20"> DialogAssistant
  </div>
...
<footer class="container">
  <div>© <span id="y"></span> ИП Мусенко Сергей Викторович (бренд WOW School)</div>
